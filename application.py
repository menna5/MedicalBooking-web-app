...
# db.execute("CREATE TABLE users(id INTEGER, username TEXT NOT NULL, hash INTEGER NOT NULL , gender TEXT, PRIMARY KEY(id))")
# db.execute("CREATE TABLE appointments(id INTEGER PRIMARY KEY, user_id INTEGER, time TEXT, description TEXT, email TEXT, name TEXT, number INTEGER, FOREIGN KEY(user_id) REFERENCES users(id))")
